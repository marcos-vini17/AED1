...
class Main:
    def __init__(self):
        dataset1 = open('../resultados/insertion_ordenado.csv', 'r')
        x = []
        y = []
        ...
        dataset2 = open('../resultados/merge_ordenado.csv', 'r')
        x = []
        y = []
        ...
        dataset3 = open('../resultados/quick_ordenado.csv', 'r')
        x = []
        y = []
        ...
        plt.title('Comparação: Ordenados')
