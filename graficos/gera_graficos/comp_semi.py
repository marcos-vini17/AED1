...
class Main:
    def __init__(self):
        dataset1 = open('../resultados/insertion_semi.csv', 'r')
        x = []
        y = []
        ...
        dataset2 = open('../resultados/merge_semi.csv', 'r')
        x = []
        y = []
        ...
        dataset3 = open('../resultados/quick_semi.csv', 'r')
        x = []
        y = []
        ...
        plt.title('Comparação: Semi ordenados')
